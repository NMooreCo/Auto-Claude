...
Examples:
  ...
  python spec_runner.py --interactive
    ...
    # NOTE: Auto-routing is disabled until frontend integration is complete.
    # Content Mode uses content_plan.json but frontend expects implementation_plan.json.
    # Use content_runner.py directly for Content Mode tasks via CLI.
    # TODO: Re-enable when frontend supports content_plan.json
